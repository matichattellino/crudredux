...
export const AGREGAR_PRODUCTO_EXITO = 'AGREGAR_PRUDUCTO_EXITO';
export const AGREGAR_PRODUCTO_ERROR = 'AGREGAR_PRUDUCTO_ERROR';
...
export const DESCARGA_PRODUCTOS_ERRROR='DESCARGA_PRODUCTOS_ERRROR';
